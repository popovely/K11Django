''' ② 테이블 생성
[next] ProjectRoot/books/admin.py '''
...
class Book(models.Model):
    ...
    on_delete=models.CASCADE
        : 오라클과 동일하게 부모레코드가 삭제될때 자식까지 같이 삭제된다.
    '''
    publisher = models.ForeignKey('Publisher', on_delete=models.CASCADE)
    # 출판일
    # publication_date = models.DateTimeField('date published') # 일종의 설명문 # 방법1
    publication_date = models.DateField()                                       # 방법2
