...
SECRET_KEY = 'django-insecure-!cn4l=i8vv9&77%w($hb^=(f(*9l=o7@k6-ql0!wivp#qkg*#5'
...
'''
DEBUG = True
# 아이피를 설정. 개발용인 경우 아래와 같이 localhost로 설정하면 된다.
ALLOWED_HOSTS = ['localhost', '127.0.0.1']


# Application definition
'''
프로젝트를 생성한 후 App을 추가하면 반드시 해당 항목에 등록해야 한다.
...
'''
장고 프레임워크에서는 CSS, JS, 이미지와 같은 정적 파일들은
static폴더에 저장하도록 규정되어있다.
개발자가 임의로 images와 같은 폴더를 생성해도 접근불가함.
'''
STATIC_URL = 'static/'
