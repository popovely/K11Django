...
def write(request):
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            '''
            문자열+정수 형태로 연결하면 파이썬에서는 에러발생함.
            따라서 정수를 문자열로 변경하기 위해
            "문자열+str(정수)" 형태로 기술해야 한다.
            '''
            Post.objects.create(
